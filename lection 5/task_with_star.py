...
def to_roman(val):
    ...
    # Решение которое нашел с помощью гугления и сам бы не догадался так как тут используется
    # наименьшие количество букв в словаре. Я бы использовал полный словарь.
    roman_dict = {
        1000: 'M',
        900: 'CM',
        500: 'D',
